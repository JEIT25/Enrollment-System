...
class ClassScheduleFactory extends Factory
{
    ...
    {
        return [
            'subject_id' => Subject::factory(), // Assuming Subject model has a factory
            'instructor_id' => Instructor::factory(), // Assuming Instructor model has a factory
            'room_id' => Room::factory(), // Assuming Room model has a factory
